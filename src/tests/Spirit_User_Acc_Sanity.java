...
public class Spirit_User_Acc_Sanity  extends AbstractUserAccBaseTest {
    ...
    public void Offers_Free_Spirit_Master_Card_Apply_Now_Enabled() throws Exception {
        ...
        App().Pages().SpiritUserAccPage().OffersLink();
        Thread.sleep(5000);
        sa.assertTrue(App().Pages().SpiritUserAccPage().OffersFreeSpiritMasterCardApplyNowEnabled());
        Thread.sleep(2000);
        String newUrl = App().Flow().getCurrentPageUrl();
        String newTitle = App().Flow().getCurrentPageTitle();
        System.out.println(newUrl);
    ...
    public void Offers_Free_Spirit_Master_Card_Banner_Displayed() throws Exception {
        ...
        App().Pages().SpiritUserAccPage().OffersLink();
        Thread.sleep(5000);
        sa.assertTrue(App().Pages().SpiritUserAccPage().OffersFreeSpiritMasterCardBannerDisplayed());
        Thread.sleep(2000);
        String newUrl = App().Flow().getCurrentPageUrl();
        String newTitle = App().Flow().getCurrentPageTitle();
        System.out.println(newUrl);
